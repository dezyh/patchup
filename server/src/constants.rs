pub const SIGN_IN_SUCCESS: &str = "Sign in success";
pub const SIGN_IN_FAILURE: &str = "Sign in failure";
pub const SIGN_UP_SUCCESS: &str = "Sign up success";
pub const SIGN_UP_FAILURE: &str = "Sign up failure";
